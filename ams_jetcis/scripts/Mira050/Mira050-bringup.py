...
import subprocess
import argparse
import fullres_mira050 as fullres
...
def initSensor_2(imager):
    ...
    imager.write(0x2076, 222)
    imager.write(0x00CE, 2)
    imager.write(0x0070, 7)
    imager.write(0x016D, 40)
    ...
    imager.write(0x0007, 5)
    imager.write(0xE004, 0)
    imager.write(0x0008, 0)
    imager.write(0x0009, 0)
    imager.write(0x000A, 97)
    imager.write(0x000B, 168)
    imager.write(0xE004, 0)
...
# imager.saveTiff('mira050_testimg')
