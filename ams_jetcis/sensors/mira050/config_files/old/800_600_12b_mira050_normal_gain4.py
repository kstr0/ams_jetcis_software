...
def initSensor(imager):
    ...
    imager.write(0x0172, 217)
    imager.write(0x0173, 0)
    imager.write(0x016F, 255)
    imager.write(0x0170, 255)
    imager.write(0x0171, 255)
    imager.write(0x0174, 217)
    imager.write(0x0175, 0)
    imager.write(0x018B, 7)
    imager.write(0x018C, 112)
    imager.write(0x018D, 2)
    imager.write(0x018E, 96)
    imager.write(0x018F, 15)
    imager.write(0x0190, 112)
    imager.write(0x0193, 16)
    imager.write(0x0194, 62)
    imager.write(0xE1A2, 3)
    imager.write(0xE1A3, 196)
    imager.write(0xE31F, 3)
    imager.write(0xE320, 205)
    imager.write(0xE1A6, 4)
    imager.write(0xE1A7, 91)
    imager.write(0xE000, 0)
