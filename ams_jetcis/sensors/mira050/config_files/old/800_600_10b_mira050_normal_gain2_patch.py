...
def initSensor(imager):
    ...
    imager.write(0x018B, 1)
    imager.write(0x018C, 80)
    imager.write(0x018D, 0)
    imager.write(0x018E, 152)
    imager.write(0x018F, 3)
    imager.write(0x0190, 80)
    imager.write(0x0193, 2)
    imager.write(0x0194, 235)
    imager.write(0xE1A2, 5)
    imager.write(0xE1A3, 121)
    imager.write(0xE31F, 5)
    imager.write(0xE320, 130)
    imager.write(0xE1A6, 6)
    imager.write(0xE1A7, 16)
    imager.write(0xE1A0, 1)
    imager.write(0xE1A1, 8)
    imager.write(0xE1B2, 1)
    imager.write(0xE1B3, 32)
    imager.write(0xE1B0, 1)
    imager.write(0xE1B1, 27)
    imager.write(0xE000, 0)
