...
def initSensor(imager):
    ...
    imager.write(0x0172, 216)
    imager.write(0x0173, 0)
    imager.write(0x016F, 255)
    imager.write(0x0170, 255)
    imager.write(0x0171, 255)
    imager.write(0x0174, 216)
    imager.write(0x0175, 0)
    imager.write(0x018B, 1)
    imager.write(0x018C, 219)
    imager.write(0x018D, 0)
    imager.write(0x018E, 152)
    imager.write(0x018F, 3)
    imager.write(0x0190, 219)
    imager.write(0x0193, 4)
    imager.write(0x0194, 6)
    imager.write(0xE1A2, 2)
    imager.write(0xE1A3, 216)
    imager.write(0xE31F, 2)
    imager.write(0xE320, 225)
    imager.write(0xE1A6, 3)
    imager.write(0xE1A7, 111)
    imager.write(0xE000, 0)
