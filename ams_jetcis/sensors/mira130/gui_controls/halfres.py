...
#//PLL bypass
    ...
    #// Vbin
    imager.write(0x3220, 0x87)
    imager.write(0x3215, 0x22)
    imager.write(0x3213, 0x08)
    imager.write(0x320a, 0x02)
    imager.write(0x320b, 0x80)
    imager.write(0x334f, 0xbe)
    imager.write(0x3231, 0x0a)
    imager.write(0x3230, 0x04)
    #// Hbin,
    imager.write(0x5000, 0x4e)
    imager.write(0x5901, 0x14)
    imager.write(0x5900, 0xf5)
    imager.write(0x3208, 0x02)
    imager.write(0x3209, 0x20)
    imager.write(0x3211, 0x08)
    #//fsync output enable
