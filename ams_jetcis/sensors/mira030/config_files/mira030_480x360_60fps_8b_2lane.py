...
def initSensor(imager):
    ...
    imager.write(0x36ea, 0x3a)
    imager.write(0x36eb, 0x0d)
    imager.write(0x36ec, 0x1d)
    imager.write(0x36ed, 0x13)
    ...
    imager.write(0x36e9, 0x00)
    imager.write(0x36f9, 0x00)
    imager.write(0x0100, 0x01)
    imager.write(0x4418, 0x08)
    imager.write(0x4419, 0x8e)
    
    imager.write(0x3208, 0x01)
    imager.write(0x3209, 0xe0)
    imager.write(0x320a, 0x01)
    imager.write(0x320b, 0x68)
    imager.write(0x3210, 0x00)
    imager.write(0x3211, 0x58)
    imager.write(0x3212, 0x00)
    imager.write(0x3213, 0x44)
