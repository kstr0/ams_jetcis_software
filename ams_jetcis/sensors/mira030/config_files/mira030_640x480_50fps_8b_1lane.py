...
def initSensor(imager):
    ...
    imager.write(0x36e9, 0x24)
    imager.write(0x36ea, 0x3b)
    imager.write(0x36eb, 0x0d)
    imager.write(0x36ec, 0x0d)
    imager.write(0x36ed, 0x23)
    imager.write(0x36f9, 0x24)
    imager.write(0x36fa, 0x3b)
    imager.write(0x36fb, 0x00)
    imager.write(0x36fc, 0x02)
    imager.write(0x36fd, 0x03)
    imager.write(0x3908, 0x91)
    imager.write(0x3d08, 0x01)
    imager.write(0x3e01, 0x18)
    imager.write(0x3e02, 0xf0)
    imager.write(0x3e06, 0x0c)
    imager.write(0x4500, 0x59)
    imager.write(0x4501, 0xc4)
    imager.write(0x4603, 0x00)
    imager.write(0x5011, 0x00)
    imager.write(0x4800, 0x64)
    imager.write(0x4809, 0x01)
    imager.write(0x5988, 0x02)
    imager.write(0x598e, 0x05)
    imager.write(0x598f, 0x17)
    imager.write(0x3217, 0x00)
    imager.write(0x3218, 0x00)
    imager.write(0x4810, 0x00)
    imager.write(0x4811, 0x01)
    imager.write(0x323b, 0x00)
    imager.write(0x3305, 0x00)
    imager.write(0x3306, 0x98)
    imager.write(0x330a, 0x01)
    imager.write(0x330b, 0x18)
    imager.write(0x3f04, 0x03)
    imager.write(0x3f05, 0x80)
    imager.write(0x36e9, 0x40)
    imager.write(0x36ea, 0x2f)
    imager.write(0x36eb, 0x0d)
    imager.write(0x36ec, 0x0d)
    imager.write(0x36ed, 0x23)
    imager.write(0x36f9, 0x62)
    imager.write(0x36fa, 0x2f)
    imager.write(0x36fb, 0x10)
    imager.write(0x36fc, 0x02)
    imager.write(0x36fd, 0x03)
    imager.write(0x3223, 0x50)
    imager.write(0x36ed, 0x20)
    imager.write(0x36fd, 0x00)
    imager.write(0x4837, 0x18)
    imager.write(0x391b, 0x81)
    imager.write(0x3252, 0x04)
    imager.write(0x3253, 0x46)
    imager.write(0x3316, 0x68)
    imager.write(0x3344, 0x64)
    imager.write(0x3335, 0x64)
    imager.write(0x332f, 0x60)
    imager.write(0x332d, 0x5c)
    imager.write(0x3329, 0x5c)
    imager.write(0x3314, 0x1e)
    imager.write(0x3317, 0x1b)
    imager.write(0x3631, 0x68)
    imager.write(0x0100, 0x01)
    imager.write(0x4418, 0x08)
    imager.write(0x4419, 0x8e)
    imager.write(0x4419, 0x80)
    imager.write(0x363d, 0x10)
    imager.write(0x3630, 0x48)
    #imager.write(0x3314, 0x1e) [gain<2]
    #imager.write(0x3317, 0x1b)
    #imager.write(0x3631, 0x68)
    #imager.write(0x3314, 0x6f) [4>gain>=2]
    #imager.write(0x3317, 0x10)
    #imager.write(0x3631, 0x48)
    #imager.write(0x3314, 0x76) [gain>=4]
