  ...
  switch (fourcc) {
    ...
    case V4L2_PIX_FMT_SRGGB12:
      structure = gst_structure_new ("video/x-bayer", "format", G_TYPE_STRING,
          fourcc == V4L2_PIX_FMT_SBGGR8 ? "bggr8" :
          fourcc == V4L2_PIX_FMT_SGBRG8 ? "gbrg8" :
          fourcc == V4L2_PIX_FMT_SGRBG8 ? "grbg8" :
          fourcc == V4L2_PIX_FMT_SRGGB8 ? "rggb8" :
          fourcc == V4L2_PIX_FMT_SBGGR10 ? "bggr10" :
          fourcc == V4L2_PIX_FMT_SGBRG10 ? "gbrg10" :
          fourcc == V4L2_PIX_FMT_SGRBG10 ? "grbg10" :
          fourcc == V4L2_PIX_FMT_SRGGB10 ? "rggb10" :
    ...
    struct v4l2_fmtdesc **format, GstVideoInfo * info)
{
  ...
  if (g_str_equal (mimetype, "video/x-raw")) {
    ...
    if (g_str_equal (mimetype, "video/mpegts")) {
      ...
      if (format) {
	if (!g_ascii_strcasecmp (format, "bggr8"))
	  fourcc = V4L2_PIX_FMT_SBGGR8;
	else if (!g_ascii_strcasecmp (format, "gbrg8"))
	  fourcc = V4L2_PIX_FMT_SGBRG8;
	else if (!g_ascii_strcasecmp (format, "grbg8"))
	  fourcc = V4L2_PIX_FMT_SGRBG8;
	else if (!g_ascii_strcasecmp (format, "rggb8"))
