...
if __name__ == "__main__":
    ...
    if test_case == 1:
        bitmodes_050 = ['12bit']#['10bit', '12bit', '10bithighspeed']
        bitmodes_220 = ['12bit']
        exposures_ms = np.arange(0,30,2)
        exposures_ms = np.array([5])#np.append(exposures_ms,[7,5.25,3.5,1.75,0.7,0.35])
    ...
    dir_results=pathlib.Path(r'./SAR_results_v2')
    print(dir_results)
